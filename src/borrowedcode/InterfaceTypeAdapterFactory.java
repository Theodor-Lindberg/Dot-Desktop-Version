        ...
        implements TypeAdapterFactory
{
	...
	@Override @SuppressWarnings("resource") public void write(final JsonWriter out, final T value) throws IOException {
	...
	@Override public T read(final JsonReader in) throws IOException {
		...
		in.endObject();
		@SuppressWarnings("unchecked") final T castValue = (T) value;
		return castValue;
